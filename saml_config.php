...
$config = array (
         ...
         */
        'auth.adminpassword'            => '{{ EXrndstring(14) }}',
         ...
         */
        'technicalcontact_name'     => '{{ tech_contact }}',
         ...
         */
        'logging.processname' => '{{ logging_process }}',

        /* Logging: file - Logfilename in the loggingdir from above.
         */
        'logging.logfile'               => '{{ log_name }}',
         ...
         */
        'language.available'    => array('en', 'no', 'nn', 'se', 'da', 'de', 'sv', 'fi', 'es', 'fr', 'it', 'nl', 'lb', 'cs',
'sl', 'lt', 'hr', 'hu', 'pl', 'pt', 'pt-br', 'tr', 'ja', 'zh', 'zh-tw', 'ru', 'et', 'he', 'id', 'sr', 'lv', 'ro'),
        ...
        'metadata.sources' => array(
                array('type' => 'flatfile'),
                array('type' => 'flatfile', 'directory' => '{{ metadata_dir }}')
        ),
         ...
         */
        'metadata.sign.enable' => {{ metadata_sign_enable }},
         ...
         */
        'metadata.sign.privatekey' => '{{ metadata_privatekey }}',
        'metadata.sign.privatekey_pass' => NULL,
        'metadata.sign.certificate' => '{{ metadata_certificate }}',
